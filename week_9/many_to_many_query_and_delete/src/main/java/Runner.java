...
//        DBHelper.deleteAll(Course.class);
        ...
        Lesson lesson1 = new Lesson("Intro to Computer Aided Design", "EE101", course1, instructor1);
        ...
        DBHelper.addInstructorToCourse(course1, instructor1);
        DBHelper.addInstructorToCourse(course1, instructor2);
        DBHelper.addInstructorToCourse(course1, instructor2);
        ...
        List<Instructor> instructorList = DBHelper.getCourseInstructors(myCourse);
        List<Lesson> studentsLesson = DBHelper.getStudentLessons(foundStudent);
        }
